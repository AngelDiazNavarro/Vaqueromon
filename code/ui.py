...
class UI:
    def __init__(self, monster, player_monsters, get_input):
        ...
        self.general_options = ["attack", "heal", "switch", "pass"]
        ...
        self.available_monsters = [
            m for m in self.player_monsters
            if m != self.monster and m.health > 0
        ]
        self.switch_index = 0
    ...
    def switch(self):
        ...
        for i in range(len(self.available_monsters)):
            ...
            text_rect = text_surf.get_frect(midleft=(x - 100, y))
